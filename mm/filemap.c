...
//CA paging routine for page cache contiguous physical page allocation per file
struct page *__page_cache_alloc_capaging(gfp_t gfp, unsigned order, unsigned long capaging_target_pfn, unsigned long capaging_next_fit_placement_request_size)
{
	int n;
	struct page *page;
	...
	return alloc_pages_pagecache_capaging(gfp, order, capaging_target_pfn, capaging_next_fit_placement_request_size);
}
EXPORT_SYMBOL(__page_cache_alloc_capaging);
