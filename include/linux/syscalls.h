...
asmlinkage long sys_capaging_register(const char __user** process_name, unsigned long num_procs, int options);
asmlinkage long sys_VMI_register(const char __user** process_name, unsigned long num_procs, int options);
/*
